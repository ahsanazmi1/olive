...
- [ ] Edge case testing for loyalty decision explanation generation
...
- [ ] New `ocn.olive.explanation.v1` event schema implemented
...
- [ ] AI-powered loyalty decision explanation generation implemented
- [ ] Human-readable incentive reasoning
